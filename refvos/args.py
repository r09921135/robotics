...
def get_parser():
    ...
    parser.add_argument('--checkpoint', default='./checkpoints/model_best_my_model.pth', help='checkpoint for inference')
    ...
    # Costum
    parser.add_argument('--inference_data_root', default='./images/inference', help='Inference dataset root directory')
    parser.add_argument('--finetune_data_root', default='./images/finetune', help='Fine-tune dataset root directory')
